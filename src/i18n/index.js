...
const messages = {
  "de": {
    "messages": {
      ...
      "method_file": "Datei",
      "method_file_step1": "Um eine Domain mit einer Datei verifizieren zu können, laden Sie bitte die HTML-Datei herunter, die wir zur Verfizierung nutzen:",
      "method_file_step2": "Im zweiten Schritt laden Sie die heruntergeladene HTML-Datei in das Hauptverzeichnis Ihrer Webseite hoch.",
      "method_file_step3": "Klicken Sie im Anschluss auf „Überprüfen“. Ist die Überprüfung erfolgreich, wird die neue Domain im Dienst von Siwecos aufgenommen bzw. gespeichert.",
      "method_file_download": "Download",
  ...
  "en": {
    "messages": {
      ...
      "method_file": "File",
      "method_file_step1": "In order to verify a domain with a file, please first download the verification HTML that we created for you:",
      "method_file_step2": "Afterwards, upload the created HTML file to the main directory of your website.",
      "method_file_step3": "Finally, click “Verify”. If verification is successful, the new domain will be accepted for the Siwecos services and saved.",
      "method_file_download": "Download",
      "method_metatag": "Meta Tag",
