        ...
        <div id="wppb-domainadd-wrap" class="wppb-domain-forms">
            <form @submit.prevent="validateAddForm" id="domainform">
                <p class="login-username">
                    ...
                    <input name="domain" id="domain" :placeholder="$t('messages.field_domain_placeholder')" type="url" v-validate="{required:true,url:true}" v-model="domain.domain" data-vv-validate-on="blur">
